...
AUDIT_CONTENT_LOCATION="${AUDIT_CONTENT_LOCATION:-/var/lib/awx/projects/rhel-hardening/files/RHEL9-CIS-Audit}"
#AUDIT_CONTENT_LOCATION="/var/lib/awx/projects/rhel-hardening/files/RHEL9-CIS-Audit"  # Location of the audit configuration file as available to the OS
